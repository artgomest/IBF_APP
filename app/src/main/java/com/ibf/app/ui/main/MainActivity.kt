...
class MainActivity : AppCompatActivity(), SelecionarPerfilSheet.PerfilSelecionadoListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
            ...
            firebaseAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this) { task ->
                    if (task.isSuccessful) {
                        // --- CORREÇÃO 1: Garante que o token seja salvo no perfil do usuário que acabou de logar ---
        ...
        // --- CORREÇÃO 2: A chamada da função agora está protegida por uma verificação de versão ---
    ...
    // --- CORREÇÃO 3: Adicionamos a anotação na função para remover o aviso de API ---
